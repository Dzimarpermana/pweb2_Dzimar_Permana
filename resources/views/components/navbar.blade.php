...
<nav class="navbar navbar-expand-lg main-navbar">
    <form class="form-inline mr-auto">
        ...
        &nbsp;
        &nbsp;
        <h1 class="font-weight-bold text-2xl text-white">{{ config('app.Sistem pengelolaan data pemeliharaan rutin jalan', 'Sistem pengelolaan data pemeliharaan rutin jalan ') }}</h1>
    </form>
